...
# printing the data type of lists print ('Data type of arr_str:, type (np_arr_str))
print('Data type of arr_num))   '
...
# Assuming `md_content` contains your Markdown content
md_content = """
# data =pd.read__csvp('foodhub_orders.csv') 
print('Data loaded successfully')
# printing the data type of lists print ('Data type of arr_str:, type (np_arr_str))
